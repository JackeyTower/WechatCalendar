...
public class GlobalException {
    ...
    public CommonResult<String> toHandlerException(Exception e) {
        ...
        if (e instanceof MethodArgumentNotValidException) {
            ...
            //文件有关的错误
            return new CommonResult<>(40016, "ERROR", e.getMessage());
        } else {
    ...
    public CommonResult<Object> toHandleUnexpectException(Exception e) {
        e.printStackTrace();
        return new CommonResult<>(500,"Error","出现错误："+ e.getMessage());
    }
}
